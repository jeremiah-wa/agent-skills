...
- **Status:** Superseded by
  [ADR-0012](0012-specify-per-component-not-per-repo.md)
- **Date:** 2026-07-25

## Context and problem statement

[ADR-0008](0008-document-with-current-state-docs-and-a-ledger.md) gave the repo
current-state docs and a ledger, justified partly as giving the repo a spec so
it can serve as a test target. The mission (see [`PRD.md`](../PRD.md)) goes
further: the documented specification of my practice is the artifact being kept,
and the skills are only its current compilation. That raises the bar on the
docs. How complete must they be?
...
- Writing the practice down to the point of reconstructability is also what
  forces me to understand it: what cannot be specified is not yet understood.
...
- Thin current-state docs only, ADR-0008 as it stood: the prompts are the
  source, the docs describe them
